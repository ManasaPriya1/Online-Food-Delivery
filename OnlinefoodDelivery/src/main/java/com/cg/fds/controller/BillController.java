...
public class BillController {
	...
	//add bill
		...
		ResponseEntity<List<Bill>> viewBills(@PathVariable("billDate") LocalDateTime billDate){
			Logger.info("Sending request to service layer to view bill by date");
			
			
			List<Bill> bil = billService.viewBills(startDate);
		...
		ResponseEntity<List<Bill>> viewBills(@PathVariable("custid")String custId){
			...
			List<Bill> bil = billService.viewBills(custId);
